...
namespace NfxSample
{
    ...
    public class AopContext
    {
        ...
        {
            var aopAttribute = MethodInfo.GetCustomAttribute<JitAopAttribute>();

            aopAttribute.Before(MethodInfo, Args);
            var result = MethodInfo.Invoke(Instance, Args);
            aopAttribute.After(MethodInfo, Args);
        ...
        public async Task<TResult> ExecuteAsync<TResult>()
        {
            ...
            await aopAttribute.BeforeAsync(MethodInfo, Args);
            var methodResult = (Task)MethodInfo.Invoke(Instance, Args);
            ...
            await methodResult.ContinueWith(async (_task) =>
            {
                ...
                await aopAttribute.AfterAsync(MethodInfo, Instance, Args);
            });
